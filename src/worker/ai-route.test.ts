      ...
      '@cf/meta/llama-3.1-8b-instruct-fast',
      {
        messages: [
          ...
          },
          {
            role: 'user',
            content:
              'Create a short, memorable sound-alike mnemonic hook to remember that the Mexican Spanish phrase "en voz alta" means "out loud". Find an English word or phrase that sounds like "en voz alta", then create a vivid, quirky 1-sentence mental image connecting that sound to "out loud". Example: "en voz alta" (out loud) sounds like "voice alter" -> Picture altering your voice so everyone hears you out loud. Output ONLY the 1-sentence mnemonic hook on a single line without any preamble or conversational filler.',
          },
        ],
        max_tokens: 150,
      },
