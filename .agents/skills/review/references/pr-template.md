# Pull Request Narrative & Verification Template

All PRs in Jolito must be self-documenting. The reviewer must evaluate whether the PR description adheres to the required narrative structure.
