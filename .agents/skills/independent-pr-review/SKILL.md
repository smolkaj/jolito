...
- When a PR touches user-facing UI, styling, copy, or interactions, reviewers must evaluate the change against [docs/DESIGN.md](../../../docs/DESIGN.md) (subtractive design, action purity, de-framing, spatial continuity, human agency, and visual coherence). Treat violations as blocking findings.
